...
#define KU_LEADER		0.0002   // Forward control coefficient
#define KW_LEADER		0.125   // Rotational control coefficient
#define KU_FOLLOWER		0.05     // Forward control coefficient
#define KW_FOLLOWER		0.100   // Rotational control coefficient
